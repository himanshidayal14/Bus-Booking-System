...
class bus_booking:
    ...
    def home_page(self):
        ...
        Label(root, text="Online Bus Booking System", font='Arial 30 bold', bg='light sky blue', fg='red',relief=RAISED,padx=10,pady=10,bd=5).grid(row=2,
                                                                                                            column=3,
                                                                                                            columnspan=9,
                                                                                                            padx=w // 2.5)
    ...
    def cover_page(self):
        ...
        Label(root, text="Online Bus Booking System", font='Arial 30 bold', bg='light sky blue', fg='red',relief=RAISED,padx=10,pady=10,bd=5).pack()
        Label(root, text="\n\n\n\n\nName: Himanshi Dayal", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nEnr. No. : 221B178", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nMobile : 8101705451\n\n\n\n", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="Submitted to: Dr. Mahesh Kumar", font='Arial 15 bold', bg='light sky blue',padx=10,pady=10, fg='red').pack()
                                            ...
                                            if len(name)>0 and len(name)<20:
                                                if age>0 and age<150:
                                                    if seats>0 and seats<60:
                                                        ...
                                                        showerror("booking limit exceed","you can only book upto 59 seats")
                                                else:
    ...
    def add_bus_op_details_page(self):
        ...
        Label(root, text="Online Bus Booking System", font='Arial 30 bold', bg='light sky blue', fg='red',relief=RAISED,padx=10,pady=10,bd=5).grid(row=1,
                                                                                                          column=0,
                                                                                                          columnspan=12)
